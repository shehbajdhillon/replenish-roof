...
import shape_1 from "@/assets/img/testimonial/shape-2-1.png";
import shape_2 from "@/assets/img/testimonial/shape-2-2.png";
...
const TestimonialAreaHomeTwo = () => {
  return (
    <>
      <div id="testimonial-one-page" className="tp-testimonial-area p-relative fix black-bg pt-120 pb-120">
        <div className="tp-testimonial-shape-4">

          <Image src={shape_1} alt="" />
        </div>
        <div className="tp-testimonial-shape-5">
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-testimonial-section-box z-index text-center mb-60">
                <span className="tp-section-subtitle text-color">OUR CLIENTS REVIEW</span>
                <h4 className="tp-section-title text-white">What they are talking about <br />our biddut services</h4>
              </div>
            </div>
            <div className="col-xl-12">
                  ...
                  {testimonials.map((item, i) => (
                    <SwiperSlide key={i} className="swiper-slide">
                      <div className="tp-testimonial-item z-index p-relative">
                        ...
                        <div className="tp-testimonial-author-box d-flex align-items-center justify-content-between">
