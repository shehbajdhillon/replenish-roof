...
export default function Banner1({t_banner_title_1, t_banner_sub_title_1}) {
            ...
            <section className="banner-area">
                ...
                <div className="banner-bg" data-background="/assets/img/banner/banner_bg.jpg">
                    <div className="banner-content">
                        <h2 className="title wow fadeInDown" data-wow-delay=".2s">{t_banner_title_1}</h2>
                        <p className="wow fadeInUp" data-wow-delay=".2s">{t_banner_sub_title_1}</p>
